...
//pre hook will run just before we save(or other operation) the data --> used in userSchema.pre()
...
userSchema.pre("save", async function (next) {
  ...
  this.password = await bcrypt.hash(this.password, 10); //await as take time //10 is the number of rounds of hashing
  next();
});
