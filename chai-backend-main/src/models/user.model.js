...
const userSchema = new Schema(
  {
    ...
    watchHistory: [
      { 
        type: Schema.Types.ObjectId,//we give id of video in this case ( that why we use .ObjectId)
        ref: "Video",
      },
    ],
    password: {
...
userSchema.methods.generateAccessToken = function () {
  return jwt.sign(
    {
      _id: this._id,//automatically generated by mongoose for each database entry
      email: this.email,
...
userSchema.methods.generateRefreshToken = function () {
  return jwt.sign(
    ...
    process.env.REFRESH_TOKEN_SECRET,///both access and refersh have differnent key
    {
...
//to access userSchema method (first create the object of User and then call the method)
// const user = new User({username: "test", email: "", fullName: "", avatar: "", password: ""})
