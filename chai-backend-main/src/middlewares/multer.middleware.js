...
const storage = multer.diskStorage({
    destination: function (req, file, cb) {//cb is callback  file option is given by multer( earlier it was not availabel)
    ...
    filename: function (req, file, cb) {//help us to give the name of file
